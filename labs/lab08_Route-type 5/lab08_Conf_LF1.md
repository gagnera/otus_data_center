...
!
ip prefix-list TO_OUTSIDE seq 10 permit 172.22.0.0/16
!
route-map TO_OUTSIDE permit 1
   match ip address prefix-list TO_OUTSIDE
!
router bgp 65000
   ...
   vrf EVPNL3
      ...
      neighbor 10.0.255.254 remote-as 65001
      neighbor 10.0.255.254 route-map TO_OUTSIDE out
      aggregate-address 172.22.0.0/16
